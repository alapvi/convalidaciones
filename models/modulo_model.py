...
class modulo_model(models.Model):
    ...
    name=fields.Char(string="Nombre",required=True,index=True,help="Nombre del modulo")
    descripcion=fields.Text(string="Descripcion",required=True,help="Descripcion del modulo")
